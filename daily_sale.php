 ...
 ?>
   <?php
     ...
     $sub_sql =" where timestamp >= '$from' && timestamp <= '$to'";
      ...
      ?> 
      <?php 
      $query = mysqli_query($conn, "SELECT count(id) AS total FROM `sale`") or die(mysqli_error());
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h3 class="font-weight-bold mb-0" style="color:#191978;">Sale</h3>
                </div>
                <div>
     <nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="home">Home</a></li>
    <li class="breadcrumb-item active" aria-current="page">Daily Sale</li>
  </ol>
</nav>
                </div>
              </div>
          ...
          <div>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card border-left-primary" id="tpurchase" >
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left">Total Sale</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                 <img src="https://img.icons8.com/external-wanicon-flat-wanicon/64/000000/external-sale-calendar-and-dates-wanicon-flat-wanicon.png" height="50px" />
...
<button name="submit" class="btn btn-success text-white btn-xs">Filter</button>
  ...
  <strong class="card-title" style="color:#191978;"><i class="ti-shopping-cart"></i>  Total sale List</strong>
                    </div>
...
<?php
$displayquery = "select * from sale $sub_sql order by id desc";
